package me.helix.clickgui.component.components;
...
import me.helix.clickgui.component.Component;
import me.helix.clickgui.component.Frame;
import me.helix.clickgui.component.components.sub.Checkbox;
import me.helix.clickgui.component.components.sub.Keybind;
import me.helix.clickgui.component.components.sub.ModeButton;
import me.helix.clickgui.component.components.sub.Slider;
import me.helix.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(Helix.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : Helix.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
