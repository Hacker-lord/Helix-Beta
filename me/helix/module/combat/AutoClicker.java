...
public class AutoClicker extends Module {
	...
	public AutoClicker() {
		...
		Helix.instance.settingsManager.rSetting(new Setting("MinCPS", this, 8, 1, 20, false));
		Helix.instance.settingsManager.rSetting(new Setting("MaxCPS", this, 12, 1, 20, false));
	}
	...
	private void updateVals() {
		min = Helix.instance.settingsManager.getSettingByName(this, "MinCPS").getValDouble();
		max = Helix.instance.settingsManager.getSettingByName(this, "MaxCPS").getValDouble();
